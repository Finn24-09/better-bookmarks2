...
| ------------------------------------------------------------------------------------- | ------- | --------------------------------------------------------- |
| [shadcn/ui](https://ui.shadcn.com/)                                                   | MIT     | https://github.com/shadcn-ui/ui                           |
| [Radix UI Primitives](https://www.radix-ui.com/)                                      | MIT     | https://www.radix-ui.com                                  |
| [React](https://react.dev/)                                                           | MIT     | https://github.com/facebook/react                         |
| [React DOM](https://react.dev/)                                                       | MIT     | https://github.com/facebook/react                         |
| [Motion](https://motion.dev/)                                                         | MIT     | https://github.com/motiondivision/motion                  |
| [Lucide React](https://lucide.dev/)                                                   | ISC     | https://github.com/lucide-icons/lucide                    |
| [Sonner](https://sonner.emilkowal.ski/)                                               | MIT     | https://github.com/emilkowalski/sonner                    |
| [Vaul](https://vaul.emilkowal.ski/)                                                   | MIT     | https://github.com/emilkowalski/vaul                      |
| [cmdk](https://cmdk.paco.me/)                                                         | MIT     | https://github.com/pacocoursey/cmdk                       |
| [next-themes](https://github.com/pacocoursey/next-themes)                             | MIT     | https://github.com/pacocoursey/next-themes                |
| [Embla Carousel](https://www.embla-carousel.com/)                                     | MIT     | https://github.com/davidjerleke/embla-carousel            |
| [input-otp](https://input-otp.rodz.dev/)                                              | MIT     | https://github.com/guilhermerodz/input-otp                |
| [react-resizable-panels](https://react-resizable-panels.vercel.app/)                  | MIT     | https://github.com/bvaughn/react-resizable-panels         |
| [react-responsive-masonry](https://github.com/cedricdelpoux/react-responsive-masonry) | MIT     | https://github.com/cedricdelpoux/react-responsive-masonry |
| [canvas-confetti](https://github.com/catdad/canvas-confetti)                          | ISC     | https://github.com/catdad/canvas-confetti                 |
...
| Package                                         | License | Link                                               |
| ----------------------------------------------- | ------- | -------------------------------------------------- |
| [React Hook Form](https://react-hook-form.com/) | MIT     | https://github.com/react-hook-form/react-hook-form |
| [React Router](https://reactrouter.com/)        | MIT     | https://github.com/remix-run/react-router          |
| [React Day Picker](https://daypicker.dev/)      | MIT     | https://github.com/gpbl/react-day-picker           |
...
| Package                                                           | License | Link                                   |
| ----------------------------------------------------------------- | ------- | -------------------------------------- |
| [react-dnd](https://react-dnd.github.io/react-dnd/)               | MIT     | https://github.com/react-dnd/react-dnd |
| [react-dnd-html5-backend](https://react-dnd.github.io/react-dnd/) | MIT     | https://github.com/react-dnd/react-dnd |
...
| Package                                                     | License    | Link                                      |
| ----------------------------------------------------------- | ---------- | ----------------------------------------- |
| [Recharts](https://recharts.org/)                           | MIT        | https://github.com/recharts/recharts      |
| [date-fns](https://date-fns.org/)                           | MIT        | https://github.com/date-fns/date-fns      |
| [clsx](https://github.com/lukeed/clsx)                      | MIT        | https://github.com/lukeed/clsx            |
| [tailwind-merge](https://github.com/dcastil/tailwind-merge) | MIT        | https://github.com/dcastil/tailwind-merge |
| [class-variance-authority](https://cva.style/)              | Apache-2.0 | https://github.com/joe-bell/cva           |
...
| [tw-animate-css](https://github.com/Wombosvideo/tw-animate-css) | MIT     | https://github.com/Wombosvideo/tw-animate-css |
...
| Package                                                             | License | Link                                        |
| ------------------------------------------------------------------- | ------- | ------------------------------------------- |
| [Vite](https://vite.dev/)                                           | MIT     | https://github.com/vitejs/vite              |
| [@vitejs/plugin-react](https://github.com/vitejs/vite-plugin-react) | MIT     | https://github.com/vitejs/vite-plugin-react |
| [@tailwindcss/vite](https://tailwindcss.com/)                       | MIT     | https://github.com/tailwindlabs/tailwindcss |
...
| [jsdom](https://github.com/jsdom/jsdom)                     | MIT     | https://github.com/jsdom/jsdom                           |
